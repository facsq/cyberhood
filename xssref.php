...
$html = "";
require_once 'verify/xssref.php';
...
<head>
	...
	<title>XSS Reflected - CyberHood</title>
...
<body style=\"background-color: #222;\" class=\"particles\">
	...
	<div class=\"container-fluid\">
		<form action=\"#\" name=\"XSS\" method=\"GET\">
			<input name=\"name\" type=\"text\" placeholder=\"What's your name?\" /><br>
